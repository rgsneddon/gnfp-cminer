...
REM PE is gnfp-cminer.exe at the zip root (0.5 leftover; DLLs sit next to it if present).
...
echo Unpack gnfp-cminer-0.5-windows.zip from rgsneddon/gnfp-cminer v0.5
